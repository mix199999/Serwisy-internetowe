...
$actions = array('wyloguj', 'user','admin', 'StartPage', 'logowanie','pageNotFound','zarzadzanieUzytkownikami', 'addvideo', 'test', 'edytuj' , 'newUser', 'watchVideo', 'watch', 'userRequests', 'search', 'tickets','reports');
