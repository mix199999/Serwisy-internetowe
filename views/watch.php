  ...
  <div class="container">
      <div class="row mt-5">
          <div class="col-md-12">
            ...
            {              
                if($userRole == 1) echo "<div class='mt-3 text-center mb-5'><a href='index.php?action=videosAdministration'> <button type='button' class='btn btn-primary'>Zarządzanie użytkownikami</button></a></div>";       //jezeli admin to dodajemy mu przycisk co przenosi do zarzadzania uzytkownikami
